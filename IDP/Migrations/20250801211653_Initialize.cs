        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalID = table.Column<int>(type: "int", fixedLength: true, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Master_AspNetUsers_CreatedByPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subsidiary_AspNetUsers_CreatedByPersonId",
                        column: x => x.CreatedByPersonId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Subsidiary_Master_MasterId",
                        column: x => x.MasterId,
                        principalTable: "Master",
                        principalColumn: "MasterId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subsidiary_Subsidiary_ParentSubsidiaryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Master_CreatedByPersonId",
                table: "Master",
                column: "CreatedByPersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Subsidiary_CreatedByPersonId",
                table: "Subsidiary",
                column: "CreatedByPersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Subsidiary_MasterId",
                table: "Subsidiary",
                column: "MasterId");

            migrationBuilder.CreateIndex(
                name: "IX_Subsidiary_ParentSubsidiaryId",
                table: "Subsidiary",
